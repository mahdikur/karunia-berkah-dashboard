...
<head>
    ...
    <style>
        ...
        .signature-area { display: flex; justify-content: flex-end; margin-top: -80px; }
...
<body onload="window.print()">
    <div class="container">
        ...
        <div class="terbilang">
            Terbilang: # {{ ucwords(\App\Helpers\FormatHelper::terbilang($invoice->total_amount)) }} Rupiah #
        </div>
        ...
        <div class="footer">
            <div style="display: flex; gap: 30px;">
                <div class="payment-info" style="width: 60%; font-size: 13px;">
                    ...
                    <div style="display: grid; grid-template-columns: 100px 10px auto; margin-top: 10px; margin-bottom: 10px;">
